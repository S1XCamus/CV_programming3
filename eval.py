...
if __name__ == '__main__':
    ...
    # loader = Dataset_Seg(r'val_pred', r'dataset/annotations_trainval', split='val').get_loader()
    loader = Dataset_Seg(r'val_pred', r'dataset/annotations_trainval', split='tt').get_loader()
    evaluate(loader, 21)
